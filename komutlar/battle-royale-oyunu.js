...
embed.setDescription(`**Battle Royale oyunu \`${channel.name}\` adlı kanalda başlatılıyor. Oynamak için ▶️ emojisine tıklayınız** `)
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["battleroyale","battleroyaleOYUN","BATTLEROYALEOYUN","battle","BATTLE"],
  permLevel: 0
};

exports.help = {
  name: 'battleroyaleoyunu',
  description: 'Youtubeden video izleyebilirsiniz.',
   kategori: "eğlence",
  usage: 'battleroyaleoyunu'
};
