...
embed.setDescription(`**Poker oyunu \`${channel.name}\` adlı kanalda başlatılıyor. Oynamak için ▶️ emojisine tıklayınız** `)
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["POKEROYUNU","POKER-OYUNU","POKER","poker","poker-oyunu"],
  permLevel: 0
};

exports.help = {
  name: 'pokereoyunu',
  description: 'Poker oyunu oynatır.',
  kategori: "eğlence",
  usage: 'pokeroyunu'
};
